        ...
        <tbody>
            ...
            <tr>
                ...
                <td class=" bg-secondary text-light">
                    {{ date('d/m/Y H:i:s', strtotime($aprendizado->getAttribute('created_at')))  }}</td>
                <td><a href="{{ route('learnings-edit', $aprendizado->getAttribute('id')) }}"><svg
                ...
                <td>
                    <form action="{{route('learnings-destroy', ['id' => $aprendizado->id]) }}" method="POST">
                        @csrf
                        @method('delete')
